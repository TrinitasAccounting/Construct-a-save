...
function SignupFormCustomer() {
    ...
    const { signupUserCustomer } = useOutletContext();
    ...
    return (
        <div className='pl-4'>
            <div className='pl-4'>
                <h2>You are signing up as a customer, who buys construction supplies</h2>
                <br />
                ...
                <div className='absolute inset-x-20 top-00 h-16 '>
                    ...
                    <span className="isolate inline-flex rounded-md shadow-sm left-10">
                        <button
                            type="button"
                            className="bg-emerald-500 relative inline-flex items-center rounded-l-md px-3 py-2 text-sm font-semibold text-gray-900 ring-1 ring-inset ring-gray-300 focus:z-10"
                        ...
                        <button
                            ...
                            onClick={() => { navigate('/distributors/signup') }}
                        >
