        ...
        <>
            <div className='m-4 grid gap-4 sm:grid-cols-12'>
                ...
                <div className='min-h-[25px] '>
                    <button onClick={openCloseDistributorSlide}
                        type="button"
            ...
            <Transition.Root show={distributorSlide} as={Fragment}>
                                                            ...
                                                            <div className="mt-4 flex text-sm">
                                                                <a href="#" className="group inline-flex items-center text-gray-500 hover:text-gray-900">
                                                                    <QuestionMarkCircleIcon
                                                                        ...
                                                                        aria-hidden="true"
                                                                    />
                                                                    <span className="ml-2">All of your distributors will receive an email and a popup message letting them know you have a new product you want to a price for</span>
                                                                </a>
                                                            </div>
                                                        </div>
                                                    </div>
